...
namespace BS.Components.Data.Entity
{
    public class MySqlEntityHelper
    {
        ...
        /// <returns></returns>
        public static T GetDataReaderObject<T>(string customColumns, MySqlDataReader sdr) where T : class
        {
            Type type = typeof(T);
            string typeName = type.Namespace + "." + type.Name;
            List<string> columns = GetTableColumns(type, ColumnTypes.Extend, customColumns);
            return GetDataReaderObject<T>(type, typeName, columns, sdr);
        }

        public static T GetDataReaderObject<T>(Type type, string typeName, List<string> columns, MySqlDataReader sdr) where T : class
        {
